...
module.exports = merge(base, {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            title: 'FoxWork New Server',
            template: 'src/renderer/index.html',
            chunks: ['newServer'],
            filename: 'newServer.html',
        }),
        new HtmlWebpackPlugin({
            title: 'FoxWork Edit Server',
            template: 'src/renderer/index.html',
            chunks: ['editServer'],
            filename: 'editServer.html',
        }),
        new HtmlWebpackPlugin({
            title: 'FoxWork Remove Server',
            template: 'src/renderer/index.html',
            chunks: ['removeServer'],
